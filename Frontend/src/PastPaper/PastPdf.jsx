...
const PastPdf = () => {
    ...
    useEffect(() => {
        const getdata = async () => {
            try {
                const response = await axios.get(`http://localhost:4000/Pastpdf`)
    ...
    return (
        <>
            {
                CourseData ?
                    <div className="h-fullmin-h-[100vh]  w-[90vw] md:w-[80vw] mx-auto bg-primary my-8 flex flex-col items-center ">
